...
import { SoundSystemTab } from '@/components/profile/tabs/SoundSystemTab';
import { LodgingTab } from '@/components/profile/tabs/LodgingTab';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        {/* Removed lodging tab inline content - replaced with LodgingTab component */}
        {false && (
          <div className="space-y-6">
