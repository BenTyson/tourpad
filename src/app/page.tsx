        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center">
            <h1 className="text-4xl sm:text-6xl font-bold text-white mb-6">
              Bringing Artists & Homes
              <span className="block text-yellow-300">Together</span>
            </h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
              Experience intimate, authentic live music in welcoming homes. 
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600">
                Discover amazing venues welcoming artists
              </p>
            </div>
            <Link href="/hosts">
            ...
            {[1, 2, 3].map((i) => (
              <Card key={i} className="overflow-hidden">
                ...
                <CardContent className="p-4">
                  <h3 className="font-semibold text-gray-900">The Garden House</h3>
                  <p className="text-sm text-gray-600 mb-2">Austin, TX</p>
                  <div className="flex items-center space-x-4 text-sm text-gray-600 mb-2">
                    <span>30 avg attendance</span>
                    <span>$15 door</span>
                  </div>
                  <div className="flex items-center">
                    <StarIcon className="w-4 h-4 text-yellow-500 fill-current" />
                    <span className="text-sm font-medium ml-1">4.9 (12)</span>
                  </div>
                </CardContent>
              </Card>
            ))}
