  ...
  if (tracks.length === 0) {
    return (
      <div className="text-center p-8 bg-gray-50 rounded-lg">
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-2">No Uploaded Tracks</h3>
                ...
                {editingTrack === track.id ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor={`public-${track.id}`} className="ml-2 text-sm text-gray-700">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            {index === currentTrackIndex && (
                              <div className="text-blue-600 text-sm font-medium">Now Playing</div>
                            )}
                          </div>
                        </div>
                        
                        {track.artist && (
                          <p className="text-sm text-gray-600 mt-1">by {track.artist}</p>
                        )}
                        
                        {track.description && (
                          <p className="text-sm text-gray-700 mt-2">{track.description}</p>
                        )}
